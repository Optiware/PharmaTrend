    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Rejoignez la communauté PharmaTrend</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.roleContainer}>
            <TouchableOpacity 
                style={[styles.roleBtn, form.role === 'PHARMACIST' && styles.roleBtnActive]}
                onPress={() => setForm({...form, role: 'PHARMACIST'})}
            >
                <Ionicons name="medkit-outline" size={20} color={form.role === 'PHARMACIST' ? 'white' : '#555'} />
                <Text style={[styles.roleText, form.role === 'PHARMACIST' && styles.roleTextActive]}>
                    Pharmacien
                </Text>
            </TouchableOpacity>
            ...
            >
                <Ionicons name="briefcase-outline" size={20} color={form.role === 'SELLER' ? 'white' : '#555'} />
                <Text style={[styles.roleText, form.role === 'SELLER' && styles.roleTextActive]}>
                    Vendeur Pro
                </Text>
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  container: { flexGrow: 1, backgroundColor: 'white', padding: 20, paddingTop: 60 },
  header: { marginBottom: 20 },
  backBtn: { marginBottom: 10 },
  title: { fontSize: 32, fontWeight: 'bold', color: '#27ae60' },
  subtitle: { fontSize: 16, color: 'gray', marginTop: 5 },
  form: { gap: 12 },
  input: { backgroundColor: '#f5f6fa', padding: 15, borderRadius: 12, fontSize: 16, marginBottom: 5, borderWidth: 1, borderColor: '#eee' },
  
  // Styles du sélecteur
  labelRole: { fontSize: 16, fontWeight: 'bold', color: '#333', marginTop: 5, marginBottom: 5 },
  roleContainer: { flexDirection: 'row', gap: 10, marginBottom: 15 },
  roleBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 15, borderRadius: 10, backgroundColor: '#f5f6fa', borderWidth: 1, borderColor: '#eee' },
  ...
  button: { backgroundColor: '#27ae60', padding: 18, borderRadius: 12, alignItems: 'center', marginTop: 10, elevation: 3 },
